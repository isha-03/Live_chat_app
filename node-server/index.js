//socket-io used on 8000 port socket.io server is running and this server will listen incoming events
...
io.on('connection',Socket=>{
    ...
    Socket.on('disconnect',message=>{//'send' is a custom name of event
